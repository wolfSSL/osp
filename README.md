...
* [Commercial licenses](https://www.wolfssl.com/license/) available (in addition to GPL-2.0-or-later)
...
wolfSSL and wolfCrypt are either licensed for use under the GPL-2.0-or-later or a standard commercial license. For users who cannot use wolfSSL under GPL-2.0-or-later, a commercial license to wolfSSL and wolfCrypt is available. For license inquiries, please contact wolfSSL Inc. directly at licensing@wolfssl.com.
