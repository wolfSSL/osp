...
##### OQS_TEMPLATE_FRAGMENT_SIG_ALGS_START
    ...
    'dilithium2','dilithium3','dilithium5','dilithium2_aes','dilithium3_aes','dilithium5_aes','falcon512','falcon1024','picnicl1full','picnic3l1','rainbowVclassic','sphincsshake256128fsimple','sphincsshake256128ssimple','sphincsshake256192fsimple','sphincsshake256192ssimple','sphincsshake256256fsimple','sphincsshake256256ssimple',
    # post-quantum + classical signatures
    'p256_dilithium2','rsa3072_dilithium2','p384_dilithium3','p521_dilithium5','p256_dilithium2_aes','rsa3072_dilithium2_aes','p384_dilithium3_aes','p521_dilithium5_aes','p256_falcon512','rsa3072_falcon512','p521_falcon1024','p256_picnicl1full','rsa3072_picnicl1full','p256_picnic3l1','rsa3072_picnic3l1','p521_rainbowVclassic','p256_sphincsshake256128fsimple','rsa3072_sphincsshake256128fsimple','p256_sphincsshake256128ssimple','rsa3072_sphincsshake256128ssimple','p384_sphincsshake256192fsimple','p384_sphincsshake256192ssimple','p521_sphincsshake256256fsimple','p521_sphincsshake256256ssimple',
