...
///// OQS_TEMPLATE_FRAGMENT_LIST_SIG_SWITCH_CASES_START
    ...
    case EVP_PKEY_P256_SPHINCSSHAKE256128FSIMPLE:
    case EVP_PKEY_RSA3072_SPHINCSSHAKE256128FSIMPLE:
    case EVP_PKEY_SPHINCSSHAKE256128SSIMPLE:
    case EVP_PKEY_P256_SPHINCSSHAKE256128SSIMPLE:
    case EVP_PKEY_RSA3072_SPHINCSSHAKE256128SSIMPLE:
    case EVP_PKEY_SPHINCSSHAKE256192FSIMPLE:
    case EVP_PKEY_P384_SPHINCSSHAKE256192FSIMPLE:
    case EVP_PKEY_SPHINCSSHAKE256192SSIMPLE:
    case EVP_PKEY_P384_SPHINCSSHAKE256192SSIMPLE:
    case EVP_PKEY_SPHINCSSHAKE256256FSIMPLE:
    case EVP_PKEY_P521_SPHINCSSHAKE256256FSIMPLE:
    case EVP_PKEY_SPHINCSSHAKE256256SSIMPLE:
    case EVP_PKEY_P521_SPHINCSSHAKE256256SSIMPLE:
