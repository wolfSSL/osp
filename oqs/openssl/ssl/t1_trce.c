...
///// OQS_TEMPLATE_FRAGMENT_SSL_GROUPS_TBL_START
    ...
    {OQS_KEM_CURVEID(NID_ntru_hps40961229), "ntru_hps40961229"},
    {OQS_KEM_CURVEID(NID_ntru_hrss701), "ntru_hrss701"},
    {OQS_KEM_CURVEID(NID_ntru_hrss1373), "ntru_hrss1373"},
...
///// OQS_TEMPLATE_FRAGMENT_SSL_GROUPS_TBL_HYBRID_START
    ...
    {OQS_KEM_CURVEID(NID_p521_ntru_hps40961229), "p521 - ntru_hps40961229 hybrid"},
    {OQS_KEM_CURVEID(NID_p384_ntru_hrss701), "p384 - ntru_hrss701 hybrid"},
    {OQS_KEM_CURVEID(NID_p521_ntru_hrss1373), "p521 - ntru_hrss1373 hybrid"},
...
///// OQS_TEMPLATE_FRAGMENT_POPULATE_SIGALG_TBL_START
    ...
    {TLSEXT_SIGALG_dilithium2_aes, "dilithium2_aes"},
    {TLSEXT_SIGALG_p256_dilithium2_aes, "p256_dilithium2_aes"},
    {TLSEXT_SIGALG_rsa3072_dilithium2_aes, "rsa3072_dilithium2_aes"},
    {TLSEXT_SIGALG_dilithium3_aes, "dilithium3_aes"},
    {TLSEXT_SIGALG_p384_dilithium3_aes, "p384_dilithium3_aes"},
    {TLSEXT_SIGALG_dilithium5_aes, "dilithium5_aes"},
    {TLSEXT_SIGALG_p521_dilithium5_aes, "p521_dilithium5_aes"},
    ...
    {TLSEXT_SIGALG_rainbowVclassic, "rainbowVclassic"},
    {TLSEXT_SIGALG_p521_rainbowVclassic, "p521_rainbowVclassic"},
    ...
    {TLSEXT_SIGALG_sphincsshake256128ssimple, "sphincsshake256128ssimple"},
    {TLSEXT_SIGALG_p256_sphincsshake256128ssimple, "p256_sphincsshake256128ssimple"},
    {TLSEXT_SIGALG_rsa3072_sphincsshake256128ssimple, "rsa3072_sphincsshake256128ssimple"},
    {TLSEXT_SIGALG_sphincsshake256192fsimple, "sphincsshake256192fsimple"},
    {TLSEXT_SIGALG_p384_sphincsshake256192fsimple, "p384_sphincsshake256192fsimple"},
    {TLSEXT_SIGALG_sphincsshake256192ssimple, "sphincsshake256192ssimple"},
    {TLSEXT_SIGALG_p384_sphincsshake256192ssimple, "p384_sphincsshake256192ssimple"},
    {TLSEXT_SIGALG_sphincsshake256256fsimple, "sphincsshake256256fsimple"},
    {TLSEXT_SIGALG_p521_sphincsshake256256fsimple, "p521_sphincsshake256256fsimple"},
    {TLSEXT_SIGALG_sphincsshake256256ssimple, "sphincsshake256256ssimple"},
    {TLSEXT_SIGALG_p521_sphincsshake256256ssimple, "p521_sphincsshake256256ssimple"},
