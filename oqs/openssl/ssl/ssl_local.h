...
#define SSL_aSPHINCSSHAKE256128FSIMPLE 0x800000000U
/* ECDSA p256 - SPHINCS+-SHAKE256-128f-simple auth */
#define SSL_aP256_SPHINCSSHAKE256128FSIMPLE 0x1000000000U
/* RSA3072 - SPHINCS+-SHAKE256-128f-simple auth */
#define SSL_aRSA3072_SPHINCSSHAKE256128FSIMPLE 0x2000000000U
/* SPHINCS+-SHAKE256-128s-simple auth */
#define SSL_aSPHINCSSHAKE256128SSIMPLE 0x4000000000U
/* ECDSA p256 - SPHINCS+-SHAKE256-128s-simple auth */
#define SSL_aP256_SPHINCSSHAKE256128SSIMPLE 0x8000000000U
/* RSA3072 - SPHINCS+-SHAKE256-128s-simple auth */
#define SSL_aRSA3072_SPHINCSSHAKE256128SSIMPLE 0x10000000000U
/* SPHINCS+-SHAKE256-192f-simple auth */
#define SSL_aSPHINCSSHAKE256192FSIMPLE 0x20000000000U
/* ECDSA p384 - SPHINCS+-SHAKE256-192f-simple auth */
#define SSL_aP384_SPHINCSSHAKE256192FSIMPLE 0x40000000000U
/* SPHINCS+-SHAKE256-192s-simple auth */
#define SSL_aSPHINCSSHAKE256192SSIMPLE 0x80000000000U
/* ECDSA p384 - SPHINCS+-SHAKE256-192s-simple auth */
#define SSL_aP384_SPHINCSSHAKE256192SSIMPLE 0x100000000000U
/* SPHINCS+-SHAKE256-256f-simple auth */
#define SSL_aSPHINCSSHAKE256256FSIMPLE 0x200000000000U
/* ECDSA p521 - SPHINCS+-SHAKE256-256f-simple auth */
#define SSL_aP521_SPHINCSSHAKE256256FSIMPLE 0x400000000000U
/* SPHINCS+-SHAKE256-256s-simple auth */
#define SSL_aSPHINCSSHAKE256256SSIMPLE 0x800000000000U
/* ECDSA p521 - SPHINCS+-SHAKE256-256s-simple auth */
#define SSL_aP521_SPHINCSSHAKE256256SSIMPLE 0x1000000000000U
...
#define SSL_PKEY_SPHINCSSHAKE256128FSIMPLE 36
#define SSL_PKEY_P256_SPHINCSSHAKE256128FSIMPLE 37
#define SSL_PKEY_RSA3072_SPHINCSSHAKE256128FSIMPLE 38
#define SSL_PKEY_SPHINCSSHAKE256128SSIMPLE 39
#define SSL_PKEY_P256_SPHINCSSHAKE256128SSIMPLE 40
#define SSL_PKEY_RSA3072_SPHINCSSHAKE256128SSIMPLE 41
#define SSL_PKEY_SPHINCSSHAKE256192FSIMPLE 42
#define SSL_PKEY_P384_SPHINCSSHAKE256192FSIMPLE 43
#define SSL_PKEY_SPHINCSSHAKE256192SSIMPLE 44
#define SSL_PKEY_P384_SPHINCSSHAKE256192SSIMPLE 45
#define SSL_PKEY_SPHINCSSHAKE256256FSIMPLE 46
#define SSL_PKEY_P521_SPHINCSSHAKE256256FSIMPLE 47
#define SSL_PKEY_SPHINCSSHAKE256256SSIMPLE 48
#define SSL_PKEY_P521_SPHINCSSHAKE256256SSIMPLE 49

#define SSL_PKEY_NUM 50
...
#define OQS_KEM_HYBRID_CURVEID(nid) \
    ...
    (nid == NID_p521_ntru_hrss1373 ? 0x2F46 : \
...
#define OQS_KEM_NID(curveID) \
  ...
  (curveID == 0x0246 || curveID == 0x2F46 ? NID_ntru_hrss1373 : \
...
#define OQS_HYBRID_KEM_NID(curveID) \
    ...
    (curveID == 0x2F46 ? NID_p521_ntru_hrss1373 : \
...
#define OQS_ALG_NAME(nid) \
  ...
  (nid == NID_ntru_hrss1373 ? OQS_KEM_alg_ntru_hrss1373 : \
...
#define TLSEXT_SIGALG_sphincsshake256128ssimple 0xfe83
#define TLSEXT_SIGALG_p256_sphincsshake256128ssimple 0xfe84
#define TLSEXT_SIGALG_rsa3072_sphincsshake256128ssimple 0xfe85
#define TLSEXT_SIGALG_sphincsshake256192fsimple 0xfe88
#define TLSEXT_SIGALG_p384_sphincsshake256192fsimple 0xfe89
#define TLSEXT_SIGALG_sphincsshake256192ssimple 0xfe8c
#define TLSEXT_SIGALG_p384_sphincsshake256192ssimple 0xfe8d
#define TLSEXT_SIGALG_sphincsshake256256fsimple 0xfe90
#define TLSEXT_SIGALG_p521_sphincsshake256256fsimple 0xfe91
#define TLSEXT_SIGALG_sphincsshake256256ssimple 0xfe94
#define TLSEXT_SIGALG_p521_sphincsshake256256ssimple 0xfe95
