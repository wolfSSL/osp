...
macro (print_used_build_config)
    ...
    if (NOT WOLFSSL)
        ...
        message (STATUS "USING WOLFSSL INSTEAD OF OPENSSL")
    endif ()
    message ("")
endmacro ()
...
macro (link_openssl)
    ...
    elseif (WOLFSSL)
        target_link_libraries (${TARGET_NAME} ${WOLFSSL}/lib/libwolfssl.so)
        set_property(TARGET ${TARGET_NAME} APPEND PROPERTY INCLUDE_DIRECTORIES ${WOLFSSL}/include/wolfssl)
    endif ()
endmacro ()
